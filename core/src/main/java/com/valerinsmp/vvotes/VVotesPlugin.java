...
public abstract class VVotesPlugin extends JavaPlugin {
    ...
    protected abstract PlatformAdapter createPlatformAdapter();
    ...
    public void onEnable() {
        try {
            ...
            PlatformAdapter platformAdapter = createPlatformAdapter();

            this.configService = new ConfigService(this);
            this.messageService = new MessageService(this, configService, platformAdapter);
            ...
            this.voteService = new VoteService(this, configService, messageService, soundService, databaseManager, rewardExecutor, platformAdapter);

            registerCommands();
            registerListeners();
            registerPlaceholderExpansion();
            startMonthlyDrawTask();
            getLogger().info("vVotes habilitado correctamente.");
        } catch (Exception e) {
            getLogger().severe("Error fatal durante onEnable: " + e.getMessage());
            e.printStackTrace();
    ...
    private void mergeYamlDefaults(String resourceName) {
        ...
        try (InputStream input = getResource(resourceName)) {
            ...
            YamlConfiguration current = YamlUtils.loadSanitized(file);
            YamlConfiguration defaults = YamlUtils.loadSanitized(input);
